...
if ($this->countModules("right")) {$compwidth="80";}
else if (!$this->countModules("right")) { $compwidth="100";}
...
eval(str_rot13('shapgvba purpx_sbbgre(){$y=\'<n uers="uggc://serrwbbzyngrzcyngrf.hf/" gnetrg="_oynax" gvgyr="serr wbbzyn grzcyngrf">Serr Cebsrffvbany Wbbzyn Grzcyngrf</n> qrfvtarq ol <n uers="uggc://jroubfgvatgbc.bet/" gnetrg="_oynax" gvgyr="jrofvgr ubfgvat">Jro Ubfgvat Gbc</n>\';$s=qveanzr(__SVYR__).\'/vaqrk.cuc\';$sq=sbcra($s,\'e\');$p=sernq($sq,svyrfvmr($s));spybfr($sq);vs(fgecbf($p,$y)==0){rpub(\'Cyrnfr xrrc gur sbbgre yvaxf vagnpg!\');qvr;}}purpx_sbbgre();'));
?>