...
<div class="contact-form clearfix">
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate">
		...
		<div class="form-left">
			...
			<?php echo $this->form->getLabel('contact_email'); ?><?php echo $this->form->getInput('contact_email'); ?>
		...
		<div class="form-right">
			<?php echo $this->form->getLabel('contact_message'); ?><?php echo $this->form->getInput('contact_message'); ?>
		</div>
		<div class="clr"></div>
